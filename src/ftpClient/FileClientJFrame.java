...
public class FileClientJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setText("10.188.2.252");
...
//            String port1="8008";
            ec=new FileDialogClient(ip,port.trim());
//            ec=new EchoClient("222.201.101.15","8008");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            FileDataClient fdc = new FileDataClient(ip,port);
            String res = fdc.fileGet(fileName);
