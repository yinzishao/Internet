 ...
 */
public class UdpJFrame11 extends javax.swing.JFrame {
...
//            Logger.getLogger(EchoClientIOJFrame1.class.getName()).log(Level.SEVERE, null, ex);
//        }
...
//            String port1="8008";
            ec=new EchoUDPClient(ip,port.trim());
//            ec=new EchoClient("222.201.101.15","8008");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UdpJFrame11().setVisible(true);
            }
        });
    }
