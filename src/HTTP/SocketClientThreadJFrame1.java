...
import EchoClientJf.EchoClient;
import HTTP.*;
import Jframe.*;
 ...
 */
public class SocketClientThreadJFrame1 extends javax.swing.JFrame {
    private EchoClient ec;
    public String address;
    /**
     * Creates new form IOJFrame
     */
    public SocketClientThreadJFrame1() {
        initComponents();
        ec=null;
...
//        jTextArea1.append("echo:"+msg + '\n');
        ...
        try {
            ...
            Logger.getLogger(SocketClientThreadJFrame1.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        msg.append("Accept: */*\r\n");
//        msg.append("Connection: Keep-Alive\r\n");
        msg.append(jTextField1.getText());
        try {
            ec.send(msg.toString());//发送一串字符。
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SocketClientThreadJFrame1().setVisible(true);
            }
        });
    }
