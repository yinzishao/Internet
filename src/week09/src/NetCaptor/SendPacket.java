...
public class SendPacket {
    ...
    private void sendTCPPacket() throws UnknownHostException, UnsupportedEncodingException {
      ...
      tcp.setIPv4Parameter(0,false,false,false,0,false,false,false,0,1010101,100, IPPacket.IPPROTO_TCP, InetAddress.getByName("192.168.207.91"), InetAddress.getByName ("192.168.207.101"));
